...
import { Tooltip, TooltipContent, TooltipTrigger, TooltipProvider } from '@tokens/ui/tooltip';
                            ...
                            <Tooltip key={index} delayDuration={300}>
                                <TooltipTrigger asChild>
                                    <Button
                                        ...
                                        className="h-7 w-7 hover:bg-gray-50/60 rounded-sm transition-all duration-150"
                                    >
                                        {action.icon}
                                    </Button>
                                </TooltipTrigger>
                                ...
                                <TooltipTrigger asChild>
                                    <div>
                                        <CopyButton
                                            ...
                                            className="h-7 w-7 flex items-center justify-center rounded-sm hover:bg-gray-50/60 transition-all duration-150"
                                        />
                                    </div>
                                </TooltipTrigger>
                                <TooltipContent
                                    ...
                                    className="bg-zinc-800 dark:bg-zinc-900 rounded-sm py-1 px-2"
                                >
                                    <p className="text-xs text-white">{copyTooltip || defaultCopyTooltip}</p>
                                </TooltipContent>
                            </Tooltip>
                        )}
                        ...
                        {onToggleReveal && (
                            <Tooltip delayDuration={300}>
                                ...
                                <TooltipContent
                                    ...
                                    className="bg-zinc-800 dark:bg-zinc-900 rounded-sm py-1 px-2"
                                >
                                    <p className="text-xs text-white">{isRevealed ? 'Hide key' : 'Show key'}</p>
                                </TooltipContent>
                            </Tooltip>
                        )}
                        ...
                        {onRegenerate && (
                            <Tooltip delayDuration={300}>
                                <TooltipTrigger asChild>
                                    ...
                                    >
                                        <RefreshCw
                                            className={`h-3 w-3 motion-reduce:animate-none ${isRegenerating ? 'animate-spin' : ''}`}
                                        />
                                    </Button>
                                </TooltipTrigger>
                                <TooltipContent
